...
urlpatterns = [
    ...
    path('follows/<int:pk>/unfollow/', FollowViewSet.as_view({'post': 'unfollows'}), name='follows-unfollows'),
    ...
    path('users/following/<int:pk>/', UserViewSet.as_view({'get': 'following'}), name='user-following-specific'),
    path('users/followers/', UserViewSet.as_view({'get': 'followers'}), name='user-followers'),
    path('users/followers/<int:pk>/', UserViewSet.as_view({'get': 'followers'}), name='user-followers-specific'),
    path('users/<int:pk>/unfollow/', UserViewSet.as_view({'get': 'unfollow'}), name='user-unfollow'),
